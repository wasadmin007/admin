  ...
  <div class="content">
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form" style="display:none;">
       <tr>
          <td><?php echo $entry_titletext; ?></td>
          <td><input type="text" name="feedback_titletext" value="<?php echo $feedback_titletext; ?>" /></td>
        </tr>
		<tr>
          <td><?php echo $entry_speed; ?></td>
          <td><input type="text" name="feedback_speed" value="<?php echo $feedback_speed; ?>" /></td>
        </tr>
		<tr>
          <td><?php echo $entry_direction; ?></td>
          <td><input type="text" name="feedback_direction" value="<?php echo $feedback_direction; ?>" /></td>
        </tr>
	  ...
	  <table id="module" class="list">
        ...
        <tbody id="module-row<?php echo $module_row; ?>">
          <tr>
            ...
            <td class="left"><select name="feedback_module[<?php echo $module_row; ?>][layout_id]">
...
function addModule() {	
	...
	html += '    <td class="left"><select name="feedback_module[' + module_row + '][layout_id]">';
	<?php foreach ($layouts as $layout) { ?>
