        ...
        <div id="tab-product">
          <table class="form">
            ...
            <tr>
              ...
              <td><select name="cancel_reason_id">
                  <?php foreach ($cancel_reasons as $cancel_reason) { ?>
                  <?php if ($cancel_reason['cancel_reason_id'] == $cancel_reason_id) { ?>
                  <option value="<?php echo $cancel_reason['cancel_reason_id']; ?>" selected="selected"><?php echo $cancel_reason['name']; ?></option>
                  <?php } else { ?>
                  <option value="<?php echo $cancel_reason['cancel_reason_id']; ?>"><?php echo $cancel_reason['name']; ?></option>
                  <?php } ?>
                  <?php } ?>
                </select></td>
            </tr>
