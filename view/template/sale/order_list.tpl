		...
		Zone
          ...
          <tbody>
            <tr class="filter">
              ...
              <td>
	      <select name="filter_country_id" onchange="$('#filter_shipping_zone_id').load('index.php?route=localisation/geo_zone/zone&token='+token+'&country_id=' + this.value + '&zone_id=0');" style="width:150px;">
                  <option value="*"></option>
              ...
              <td id="payment-address">
	       <select name="filter_zone_id" id="filter_shipping_zone_id" style="width:150px;">
                  <option value="*"></option>
