...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <h1><img src="view/image/feedback.png" alt="" /> <?php echo $heading_title; ?></h1>
          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($feedback['selected']) { ?>
                ...
                <?php } ?></td>
              <td class="left"><?php echo $feedback['name']; ?></td>
               <td class="left"><?php echo $feedback['feedback']; ?></td>
              <td class="left"><?php echo $feedback['status']; ?></td>
              <td class="left"><?php echo $feedback['date_added']; ?></td>
