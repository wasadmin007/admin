      ...
      <table class="form">
        <tr>
          ...
          <td><?php echo $entry_status; ?>
            <select name="filter_cancel_status_id">
      ...
      <table class="list">
        <thead>
          <tr>
            ...
            <td class="right"><?php echo $column_cancels; ?></td>
          </tr>
        </thead>
        <tbody>
          <?php if ($cancels) { ?>
          ...
          <tr>
            <td class="left"><?php echo $cancel['date_start']; ?></td>
            <td class="left"><?php echo $cancel['date_end']; ?></td>
            <td class="right"><?php echo $cancel['cancels']; ?></td>
          </tr>
          <?php } ?>
          <?php } else { ?>
          <tr>
...
function filter() {
	url = 'index.php?route=report/sale_cancel&token=<?php echo $token; ?>';
