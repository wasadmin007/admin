        ...
        <table id="zone-to-geo-zone" class="list">
          ...
          <tbody id="zone-to-geo-zone-row<?php echo $zone_to_geo_zone_row; ?>">
            <tr>
              ...
              <td class="left"><select name="zone_to_geo_zone[<?php echo $zone_to_geo_zone_row; ?>][zone_id]" id="zone<?php echo $zone_to_geo_zone_row; ?>" onchange="$('#city<?php echo $zone_to_geo_zone_row; ?>').load('index.php?route=localisation/geo_zone/city&token=<?php echo $token; ?>&zone_id=' + this.value + '&city_id=0');">
				...
				<td class="left"><select name="zone_to_geo_zone[<?php echo $zone_to_geo_zone_row; ?>][city_id]" id="city<?php echo $zone_to_geo_zone_row; ?>">
                </select></td>
...
$('#city-id').load('index.php?route=localisation/geo_zone/city&token=<?php echo $token; ?>&zone_id=' + $('#zone-id').attr('value') + '&city_id=0');
...
$('#city<?php echo $zone_to_geo_zone_row; ?>').load('index.php?route=localisation/geo_zone/city&token=<?php echo $token; ?>&zone_id=<?php echo $zone_to_geo_zone['zone_id']; ?>&city_id=<?php echo $zone_to_geo_zone['city_id']; ?>');
//--></script>
<?php $zone_to_geo_zone_row++; ?>
<?php } ?>
...
function addGeoZone() {
	...
	<?php } ?>   
	html += '</select></td>';
	html += '<td class="left"><select name="zone_to_geo_zone[' + zone_to_geo_zone_row + '][zone_id]" id="zone' + zone_to_geo_zone_row + '"onchange="$(\'#city' + zone_to_geo_zone_row + '\').load(\'index.php?route=localisation/geo_zone/city&token=<?php echo $token; ?>&zone_id=\' + this.value + \'&city_id=0\');" >';
	<?php foreach ($zones as $zone) { ?>
	
	html += '<option value="<?php echo $zone['zone_id']; ?>"><?php echo addslashes($zone['name']); ?></option>';
	<?php } ?>   
	html += '</select></td>';
	html += '<td class="left"><select name="zone_to_geo_zone[' + zone_to_geo_zone_row + '][city_id]" id="city' + zone_to_geo_zone_row + '"></select></td>';
	...
	$('#city' + zone_to_geo_zone_row).load('index.php?route=localisation/geo_zone/city&token=<?php echo $token; ?>&zone_id=' + $('#zone' + zone_to_geo_zone_row).attr('value') + '&city_id=0');
