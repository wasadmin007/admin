                ...
                else
                {
                    ...
                    else
                    {
                        for (;;)
                        {
                            ...
                            else if (d in CKEDITOR.dtd.$listItem && !o(d, g)) i.onTagOpen(d == "li" ? "ul" : "dl",
                            {}, 0, 1);
        ...
        CKEDITOR.menu = CKEDITOR.tools.createClass(
        {
            ...
            _:
            {
                ...
                showSubMenu: function(a)
                {
                    ...
                    {
                        c ? c.removeAll() : (c = this._.subMenu = new CKEDITOR.menu(this.editor, CKEDITOR.tools.extend(
                        {}, this._.definition,
                        {
                            level: this._.level + 1
                    ...
                    switch (d)
                    {
                        ...
                        case CKEDITOR.SHIFT + 9:
                            for (; !b || !b.items.length;)
                                if (b = 9 == d ? (b ? b.next : c.toolbar.next) || a.toolbox.toolbars[0] : (b ? b.previous : c.toolbar.previous) || a.toolbox.toolbars[a.toolbox.toolbars.length - 1], b.items.length)
            ...
            for (var c = c.getRanges(), b = [], a = {}, e = 0; e < c.length; e++)
            {
                ...
                else
                {
                    ...
                    for (f.guard = d; g = f.next();)
                        if ((g = g.getAscendant("td") || g.getAscendant("th")) && !g.getCustomData("selected_cell")) CKEDITOR.dom.element.setMarker(a, g, "selected_cell", !0), b.push(g)
                }
            }
