...
class ModelLocalisationGeoZone extends Model {
	public function addGeoZone($data) {
			...
			$query_city = $this->db->query("SELECT name FROM `" . DB_PREFIX . "city` WHERE zone_id = '"  . $value['zone_id'] . "' AND city_id = '"  . $value['city_id'] . "'  ");
			$query_city =  $query_city->row['name'];
			
			//$this->db->query("INSERT INTO " . DB_PREFIX . "zone_to_geo_zone SET country_id = '"  . (int)$value['country_id'] . "', zone_id = '"  . (int)$value['zone_id'] . "', city_id = '"  . (int)$value['city_id'] . "', city = '" . $query . "' geo_zone_id = '"  .(int)$geo_zone_id . "', date_added = NOW()");
			$this->db->query("INSERT INTO " . DB_PREFIX . "zone_to_geo_zone SET country_id = '"  . (int)$value['country_id'] . "', zone_id = '"  . (int)$value['zone_id'] . "', city_id = '"  . (int)$value['city_id'] . "', city = '" . $query_city . "', geo_zone_id = '"  .(int)$geo_zone_id . "', date_added = NOW()");
