...
class ControllerCatalogFeedback extends Controller {
	...
	private function getList() {
		...
		$this->data['column_feedback'] = $this->language->get('column_feedback');
		$this->data['entry_text'] = $this->language->get('column_name');
		$this->data['entry_name'] = $this->language->get('entry_feedback');
		...
		$this->data['sort_product'] = $this->url->link('catalog/feedback', 'token=' . $this->session->data['token'] . '&sort=pd.name' . $url, 'SSL');
		$this->data['sort_name'] = $this->url->link('catalog/feedback', 'token=' . $this->session->data['token'] . '&sort=r.name' . $url, 'SSL');
		$this->data['sort_rating'] = $this->url->link('catalog/feedback', 'token=' . $this->session->data['token'] . '&sort=r.rating' . $url, 'SSL');
		$this->data['sort_status'] = $this->url->link('catalog/feedback', 'token=' . $this->session->data['token'] . '&sort=r.status' . $url, 'SSL');
		$this->data['sort_date_added'] = $this->url->link('catalog/feedback', 'token=' . $this->session->data['token'] . '&sort=r.date_added' . $url, 'SSL');
	...
	private function getForm() {
		...
		$this->data['entry_text'] = $this->language->get('entry_feedback');
		...
		if (isset($this->request->post['name'])) {
			...
			$this->data['name'] = $feedback_info['name'];
		} else {
			$this->data['name'] = '';
		}
		...
		if (isset($this->request->post['text'])) {
			...
			$this->data['text'] = $feedback_info['feedback'];
		} else {
			$this->data['text'] = '';
		}
